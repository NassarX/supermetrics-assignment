# Super Metrics PHP Test Assignment

>This is my solution for the **Super Metrics** PHP Test Assignment. The original code can be found at [super-metrics repository](https://github.com/supermetrics-public/php-assignment).
>
>All changes I make to the code will be submitted as pull requests to the original repository.
---
##### Table of Contents
